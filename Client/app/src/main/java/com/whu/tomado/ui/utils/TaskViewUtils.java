...
public class TaskViewUtils {
    ...
    // 获取对应Todo的详细信息
    public static Todo getAddOrEditTodoInfo(View dialogView, Context context){
        // 处理确定按钮点击事件
        taskNameEditText = dialogView.findViewById(R.id.taskNameEditText);
        taskNotesEditText = dialogView.findViewById(R.id.taskNotesEditText);
        taskCycleTotEditText = dialogView.findViewById(R.id.taskCycleTotEditText);
        ...
        int taskCycleTot = toInt(taskCycleTot_string, taskRepeat, "完成的周期数应为整数",context);
        ...
        return new Todo(taskName, taskTime, taskNotes, taskCycleTot, taskCycleTime, taskRepeat);
    }
